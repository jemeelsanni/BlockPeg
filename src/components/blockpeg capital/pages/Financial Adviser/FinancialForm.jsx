...
const FinancialForm = () => {
  return (
    <div>
        <div className=' mx-[408px] mt-[139px] mb-[65px] text-[#0B245B]'>
            <div className='text-center '>
                <h1 className='literata text-5xl font-bold mb-10'>Inquiries</h1>
                <p className='lato mb-20'>Fill in your details and go ahead with your enquiry and you will recieve a response within 24hours</p>
            </div>
