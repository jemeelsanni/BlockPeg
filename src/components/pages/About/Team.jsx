...
const Team = () => {
  return (
    <div>
      {/* Desktop */}
      <div className="container mx-auto py-10 hidden sm:hidden lg:block xl:block">
      ...
      {/* Mobile */}
      <div className="container mx-auto py-10 sm:block lg:hidden xl:hidden">
        <h1 className="text-4xl font-bold text-[#0c3c4c] text-center mb-5 title">
          The Team
        </h1>
        <div className="grid grid-cols-1 w-full justify-between">
          <div className=" bg-slate-200 flex flex-col justify-center items-center p-8 hover:bg-[#0c3c4c] text-[#0c3c4c] hover:text-slate-200 gap-3">
            <img
              src={Profile}
              alt=""
              className="h-56 w-56 border-2 border-[#0c3c4c] rounded-full "
            />
            <div className="flex flex-col justify-center items-center text-center gap-2">
              <div>
                <h2 className="head text-xl font-extrabold">Leroy Jenkins</h2>
